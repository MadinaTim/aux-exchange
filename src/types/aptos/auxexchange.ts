...
export class amm extends AptosBaseProcessor {
  ...
  static bind(options: Partial<AptosBindOptions> = {}): amm {
    return new amm({ ...amm.DEFAULT_OPTIONS, ...options });
  }

  onEntryAddApproximateLiquidity(
    func: (call: amm.AddApproximateLiquidityPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
  ...
  onEntryAddExactLiquidity(
    func: (call: amm.AddExactLiquidityPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): amm {
    this.onEntryFunctionCall(
  ...
  onEntryAddLiquidity(
    func: (call: amm.AddLiquidityPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): amm {
    this.onEntryFunctionCall(
  ...
  onEntryCreatePool(
    func: (call: amm.CreatePoolPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): amm {
    this.onEntryFunctionCall(
  ...
  onEntryRemoveLiquidity(
    func: (call: amm.RemoveLiquidityPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): amm {
    this.onEntryFunctionCall(
  ...
  onEntryResetPool(
    func: (call: amm.ResetPoolPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): amm {
    this.onEntryFunctionCall(
  ...
  onEntryUpdateFee(
    func: (call: amm.UpdateFeePayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): amm {
    this.onEntryFunctionCall(
  ...
  onEventSwapEvent(
    func: (event: amm.SwapEventInstance, ctx: AptosContext) => void,
    fetchConfig?: MoveFetchConfig
  ): amm {
    this.onMoveEvent(
      func,
  ...
  onEventAddLiquidityEvent(
    func: (event: amm.AddLiquidityEventInstance, ctx: AptosContext) => void,
    fetchConfig?: MoveFetchConfig
  ): amm {
    this.onMoveEvent(
      func,
  ...
  onEventRemoveLiquidityEvent(
    func: (event: amm.RemoveLiquidityEventInstance, ctx: AptosContext) => void,
    fetchConfig?: MoveFetchConfig
  ): amm {
    this.onMoveEvent(
      func,
...
export namespace amm {
  ...
  export interface AddApproximateLiquidityPayload<T0 = any, T1 = any>
    ...
    > {
    arguments_decoded: [bigint, bigint, bigint, bigint, bigint, bigint];
...
export class vault extends AptosBaseProcessor {
  ...
  onEntryAddAuthorizedTrader(
    func: (call: vault.AddAuthorizedTraderPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): vault {
    this.onEntryFunctionCall(
  ...
  onEntryCreateAuxAccount(
    func: (call: vault.CreateAuxAccountPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): vault {
    this.onEntryFunctionCall(
  ...
  onEntryCreateVault(
    func: (call: vault.CreateVaultPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): vault {
    this.onEntryFunctionCall(
  ...
  onEntryDeposit(
    func: (call: vault.DepositPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): vault {
    this.onEntryFunctionCall(
  ...
  onEntryTransfer(
    func: (call: vault.TransferPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): vault {
    this.onEntryFunctionCall(
  ...
  onEntryWithdraw(
    func: (call: vault.WithdrawPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): vault {
    this.onEntryFunctionCall(
  ...
  onEventTransferEvent(
    func: (event: vault.TransferEventInstance, ctx: AptosContext) => void,
    fetchConfig?: MoveFetchConfig
  ): vault {
    this.onMoveEvent(
      func,
...
export namespace vault {
  ...
  export interface CreateAuxAccountPayload extends TypedFunctionPayload<[]> {
    arguments_decoded: [];
    type_arguments: [];
  }

  export interface CreateVaultPayload extends TypedFunctionPayload<[]> {
    arguments_decoded: [];
    type_arguments: [];
  }
...
export class router extends AptosBaseProcessor {
  constructor(options: AptosBindOptions) {
  ...
  static bind(options: Partial<AptosBindOptions> = {}): router {
...
export class aux_coin extends AptosBaseProcessor {
  constructor(options: AptosBindOptions) {
  ...
  static bind(options: Partial<AptosBindOptions> = {}): aux_coin {
    return new aux_coin({ ...aux_coin.DEFAULT_OPTIONS, ...options });
  }

  onEntryInitializeAuxCoin(
    func: (call: aux_coin.InitializeAuxCoinPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): aux_coin {
    this.onEntryFunctionCall(
  ...
  onEntryMint(
    func: (call: aux_coin.MintPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): aux_coin {
    this.onEntryFunctionCall(
  ...
  onEntryRegisterAccount(
    func: (call: aux_coin.RegisterAccountPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): aux_coin {
    this.onEntryFunctionCall(
...
export namespace aux_coin {
  ...
  export interface InitializeAuxCoinPayload extends TypedFunctionPayload<[]> {
    arguments_decoded: [];
    type_arguments: [];
  }
  ...
  export interface RegisterAccountPayload extends TypedFunctionPayload<[]> {
    arguments_decoded: [];
    type_arguments: [];
  }
}
...
export class fake_coin extends AptosBaseProcessor {
  constructor(options: AptosBindOptions) {
  ...
  static bind(options: Partial<AptosBindOptions> = {}): fake_coin {
    return new fake_coin({ ...fake_coin.DEFAULT_OPTIONS, ...options });
  }

  onEntryBurn(
    func: (call: fake_coin.BurnPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): fake_coin {
    this.onEntryFunctionCall(
  ...
  onEntryMint(
    func: (call: fake_coin.MintPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): fake_coin {
    this.onEntryFunctionCall(
  ...
  onEntryRegister(
    func: (call: fake_coin.RegisterPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): fake_coin {
    this.onEntryFunctionCall(
  ...
  onEntryRegisterAndMint(
    func: (call: fake_coin.RegisterAndMintPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): fake_coin {
    this.onEntryFunctionCall(
...
export class clob_market extends AptosBaseProcessor {
  constructor(options: AptosBindOptions) {
  ...
  static bind(options: Partial<AptosBindOptions> = {}): clob_market {
    return new clob_market({ ...clob_market.DEFAULT_OPTIONS, ...options });
  }

  onEntryCancelAll(
    func: (call: clob_market.CancelAllPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): clob_market {
    this.onEntryFunctionCall(
  ...
  onEntryCancelOrder(
    func: (call: clob_market.CancelOrderPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): clob_market {
    this.onEntryFunctionCall(
  ...
  onEntryCreateMarket(
    func: (call: clob_market.CreateMarketPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): clob_market {
    this.onEntryFunctionCall(
  ...
  onEntryFastCancelOrder(
    func: (call: clob_market.FastCancelOrderPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): clob_market {
    this.onEntryFunctionCall(
  ...
  onEntryPlaceOrder(
    func: (call: clob_market.PlaceOrderPayload, ctx: AptosContext) => void,
    filter?: CallFilter,
    fetchConfig?: MoveFetchConfig
  ): clob_market {
    this.onEntryFunctionCall(
  ...
  onEventL2Event(
    func: (event: clob_market.L2EventInstance, ctx: AptosContext) => void,
    fetchConfig?: MoveFetchConfig
  ): clob_market {
    this.onMoveEvent(
      func,
...
export namespace clob_market {
  ...
  export interface AllOrdersEventInstance
    extends TypedEventInstance<AllOrdersEvent> {
  ...
  export interface L2EventInstance extends TypedEventInstance<L2Event> {
  ...
  export interface OpenOrdersEventInstance
    extends TypedEventInstance<OpenOrdersEvent> {
  ...
  export interface OrderCancelEventInstance
    extends TypedEventInstance<OrderCancelEvent> {
  ...
  export interface OrderFillEventInstance
    extends TypedEventInstance<OrderFillEvent> {
  ...
  export interface OrderPlacedEventInstance
    extends TypedEventInstance<OrderPlacedEvent> {
  ...
  export interface FastCancelOrderPayload<T0 = any, T1 = any>
    extends TypedFunctionPayload<[Address, bigint, bigint, Boolean]> {
